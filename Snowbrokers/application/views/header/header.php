					...
					?>
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								...
								<li>
									<a onclick="chgpass();" href="javascript:void(0)">Change Password</a>
									<!--<a href="<?php base_url();?>myaccount/change_password">Change Password</a>-->
								</li>
								<li>
									<a href="<?php echo base_url();?>myaccount/track_product">Track Your Product</a>
								</li>
								<?php
						...
						?>
						<li>
							<a href="<?php echo base_url();?>product/basic_details" style="color:#d09700;"><b>SELL YOUR PRODUCT</b></a>
						</li>
						<?php } ?>
					<?php
					}
	...
	<!--=========== ADDED FOR FLASH MESSAGE (PRITAM-- 30/7/14) ====================-->
		...
		<?php
			...
			if($flash_message == 'not_activated') {
                                  ...
                                  echo '<i class="icon-ok-sign"></i><strong>Success</strong>&nbsp;!&nbsp;You have successfully created an account, Please Check Your Email. Your Account will be activated within 24 Hours.';
                                  echo '</div>';
                        }
			...
			if($flash_message == 'n_activated') {
			    ...
			    echo '<div class="alert alert-error" style="background-color: rgb(248, 201, 201);color: rgb(243, 48, 48);border-color: rgb(247, 131, 131);text-align: center; font-size: larger;">';
			    echo '<i class="icon-remove-sign"></i>&nbsp<strong>Error</strong>&nbsp;!&nbsp;Your account is not activated now.';
			    echo '</div>';
			}
...
<!-----------------REGISTRATION FORM FOR BUYERS-----WORKED -> PRITAM (29,30/7/2014)--------------------------------------------------------->
				...
				<form class="bg-form clearfix" method="post" id="myform" name="myform" action="<?php echo base_url('registration/add');?>" onsubmit="return check_buyers();">
					...
					<div class="form-group">
						...
						?>
						<div class="select-box-style">
							<select id="selectproduct" name="product_type[]" multiple="multiple" label="Products of interest">
								<?php
								foreach($res as $row)
								{
								?>
					...
					<div id='error_div' class="form-group" style="font-size: 10pt;"></div>
					<div class="checkbox">
						...
						<input type="checkbox" class="checkbox" id="subscription_for_newletter" name="subscription_for_newletter" label="Accept Terms">
						<label for="subscription_for_newletter" class="checkbox_label" id="subscription_for_newletter_label" style="width: 3%;"></label> Sign up for our newsletter
			  ...
			  <?php
				...
				<!--<form class="bg-form clearfix">-->
					...
					<div class="form-group">
						...
						<div>
							<select id="select24" name="product_type[]" multiple="multiple">
					...
					<div id='error_div2' class="form-group" style="font-size: 10pt;"></div>
					
					<div class="checkbox">
						<!--<input type="checkbox" class="checkbox" id="checkbox-12" name="perspiciatis">
						<label for="checkbox-12" class="checkbox_label">Sed ut perspiciatis unde omnis iste natus</label>-->
						<input type="checkbox" class="checkbox" id="subscription_for_newletter1" name="subscription_for_newletter" label="Accept Terms">
						<label for="subscription_for_newletter1" class="checkbox_label" id="subscription_for_newletter1_label" style="width: 3%;"></label> Sign up for our newsletter
						<label id="agree_error" style="display: none;"></label>
						<!--<input style="display: none;" name="check" value="sellers"> <!------ take the value to controller for seperate sellers and Sellers------->
					</div>
					<div class="checkbox">
						<!--<input type="checkbox" class="checkbox" id="checkbox-12" name="perspiciatis">
						<label for="checkbox-12" class="checkbox_label">Sed ut perspiciatis unde omnis iste natus</label>-->
...
<!--===================================================LOGIN FORM ====WORKED (PRITAM -- 29,30/7/14)============================================-->				
				...
				<!--=========== ADDED FOR FLASH MESSAGE (PRITAM-- 30/7/14) ====================-->
					  ...
					  if($flash_message == 'n_activated') {
                                              ...
                                              echo '<div class="alert alert-error" style="background-color: rgb(248, 201, 201);color: rgb(243, 48, 48);border-color: rgb(247, 131, 131);">';
                                              echo '<i class="icon-remove-sign"></i>&nbsp<strong>Error.! &nbsp</strong> Your account is not activated now.';
                                              echo '</div>';
					  }
...
function check_buyers()
{
	...
	else
	{
		...
		{
			error_div.html('Please accept terms and coditions.');
...
<script>
	function chgpass()
	{
		 ...
		 window.location.assign("<?php echo base_url();?>myaccount/change_password");
