  ...
  <div id="tabs-1">
	...
	?>
		...
		//exit;
			...
			?>
					<label style="float: left; margin-right: 10px;"><b><?php echo $msg_details_user[0]->first_name." ".$msg_details_user[0]->last_name;?>&nbsp;&nbsp;<?php if($post_details_user > 0){echo $post_details_user[0]->task_code; } else {echo "";}?></b></label>
					<?php
					}
					 ?>
