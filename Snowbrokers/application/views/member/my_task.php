...
<section class="innerpage_page">
  ...
  <ul class="tab-links">
    ...
    <li><a href="#tabs-2" >Awarded Task</a></li>
    <li><a href="#tabs-3" >Completed Task</a></li>
  ...
  <div id="tabs-1">
	...
	?>
		...
		<?php
		$i=1;
		$task_details1=$this->modelsignup->complete_task();
		
		if(count($task_details1)>0)
		{
			
			foreach($task_details1 as $task)
			{

			    $encrypt_id=urlencode(base64_encode($task->id));
			    if($i==count($task_details1))
			    {
				    $bottom_style="border-bottom:none !important";
			    }
			    else
