  ...
  <div id="tabs-1">
	...
	?>
		...
		if(count($msg_details)>0)
		{
			...
			?>
					<a href="<?php echo base_url();?>index.php/signup/msg_details/<?php echo $msg->id;?>"><label <?php echo $msg_color;?>><?php echo $i.".".$msg->first_name." ".$msg->last_name;?>&nbsp;&nbsp;<?php if($post_details_user > 0){echo $post_details_user[0]->task_code; } else {echo "";}?></label>
