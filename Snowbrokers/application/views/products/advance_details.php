    ...
    <div class="container">
        <div class="shipping-content clearfix">
            ...
            <div class="form-hedding">
                    ...
                    <div class="pull-right"><a href="javascript:void(0);" data-toggle="modal" data-target="#needHelpsection">Need help?</a>
                    </div>
            </div>
            <?php
            ...
            ?>
                <div class="browse-loop clearfix">
                    ...
                    <div class="color_img" id="color_<?php echo $value->id; ?>" style="border-color:#000000;border:3px;height: 20px;width: 100%;background-color: <?php echo $value->color_code;?>;"></div>
            <?php
