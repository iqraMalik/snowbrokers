    ...
    <div class="container">
        <div class="shipping-content clearfix">
            ...
            <div class="besic-form-row basic_row">
                ...
                <form action="<?php echo site_url('shipping_details/advance_features_post');?>" name="adva_add" id="adva_add" method="post" onsubmit="return check_Form_Advance();">
                    ...
                    <input class="submit_cont" type="submit" value="Submit or Add Another Color" name="Submit" id="submit" />
                </form>
        ...
        <?php
            ...
            <div class="details_pros">
                <div class="avalable_pro">
                    <span class="quanity_head">Size:</span>
                    <span class="size_cell"><?php 
                  
                    if($this->site_settingsmodel->get_size($value_id->product_related_size_id))
                       {
                        echo $this->site_settingsmodel->get_size($value_id->product_related_size_id);
                       }
                       else{
                        echo"N/A";
                       }
    ...
    foreach($get_color_status as $imgvalue)
       {
        ...
        ?>
            <!--<a href="<?php echo site_url('myaccount/track_product'); ?>" style="margin-top: 10px;padding-top: 10px;">Click here to view the listing of your products</a>-->
            <div style="text-align:right;"><a style="margin-top: 10px;padding-top: 10px;font-size:16px;color:#000000;" href="<?php echo site_url('myaccount/track_product'); ?>">Click here to view the listing of your products</a></div>
        </div>
...
//function apply_quantity(product_id,color_id,id)
//{
//   id=id.replace("apply_","quntity_");
//   alert(id);
//   var quinty=$('#'+id).val();
//   if(quinty.search(/\S/)!=-1)
//{
//$.ajax({
//		    url: "<?php echo base_url(); ?>index.php/shipping_details/add_new_quintity",
//		    data: {
//			product_id: product_id,color_id: color_id,quinty: quinty
//		           },
//                    type: "post",
        ...
        Dropzone.options.myAwesomeDropzone = {
            ...
            init: function() {
                        this.on("success", function(file, response) {
                           ...
                           //alert(file.serverId);
                            total_image_count++;
                            $('#image_status').val(total_image_count);
                        });
