	...
	<div class="page-header">
		<h4>
		Updating <?php echo $user[0]['contryname'].' '.$user[0]['shortname'];?>
		</h4>
	</div>
	...
	<div class="sortable row-fluid">
		...
		function chkFrm()
		{
			...
			{
				document.getElementById('last_nameerr').innerHTML = 'Please Enter the Short Name...';
				return false;
			}
			else
			{
		...
		<?php
			...
			echo form_open_multipart('admin/admin_country_management/update/'.$this->uri->segment(4).'', $attributes);
		?>
			<fieldset>
				...
				<div class="control-group">
					...
					<div style="margin-left: 120px;" class="controls">
						<input type="text" id="country_name" name="country_name" value="<?php echo $user[0]['contryname']; ?>" >
