	...
	<div class="sortable row-fluid">
		...
		<?php
			...
			echo form_open_multipart('admin/admin_product/update/'.$this->uri->segment(4).'', $attributes);
		?>
			<fieldset>
				...
				<div class="control-group">
					...
					<div style="margin-left: 120px;" class="controls">
						<input type="text" id="product_name" name="product_name" value="<?php echo $cat[0]['name'];?>" onkeyup="chech_name()" >
				...
				<div class="control-group">
					...
					<select style="width: 200px; height: 30px; margin-left: 25px" id="parent_cate" name="parent_cate">						
						...
						<?php 
							...
							{								
						?>							
							<option value="<?php echo $catname['id']; ?>" <?php if($catname['id'] == $cat[0]['category']){ echo "selected";}; ?>><?php echo $catname['name'];?></option>							
				...
				<div class="control-group">
					...
					<img src="<?php echo base_url()."assets/uploads/product_img/thumb/".$cat[0]['image'];?>" style="height: 80px">
