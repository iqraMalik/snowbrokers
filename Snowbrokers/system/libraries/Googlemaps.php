...
class Googlemaps {
	...
	function add_marker($params = array())
	{
		...
		$marker['icon_scaledSize'] = '30,50';						// The size of the entire image after scaling, if any. Use this property to stretch/shrink an image or a sprite. Expecting two comma-separated values for width and height respectively (ie '20,30')
		...
		$marker['animation'] = '30,50'; 								// blank, 'DROP' or 'BOUNCE'
