				...
				<div class="row-fluid filter-block">
					...
					<div class="pull-right">
						<form name="search_form" id="search_form" method="post" action="">
							...
							<input type="text" id="sort_type" name="sort_type" value="<?php echo $sort_type;?>" />
							<input type="text" id="sort_field" name="sort_field" value="<?php echo $sort_field;?>" />
							<input type="text" name="search_mode" id="search_mode" value="" />
							<input type="text" name="btnVal" id="btnVal" value="<?php echo $myval;?>"/>
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5">
										<a id="title" href="javascript:void(0);" onclick="sortField('title');" style="color:#000;text-decoration: none;">Qustion
										<?php
											if($sort_field=='title')
											{
												if($sort_type=="DESC")
