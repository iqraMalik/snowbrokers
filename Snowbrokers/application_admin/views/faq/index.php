		...
		<div id="main-stats">
			<div class="table-products">
				...
				<div class="row-fluid filter-block">
					...
					<div class="pull-left">
						<form name="search_form" id="search_form" method="post" action="">
							...
							<input type="hidden" id="sort_type" name="sort_type" value="<?php echo (isset($sort_type)?$sort_type:get_cookie('faq_type'));?>" />
							<input type="hidden" id="sort_field" name="sort_field" value="<?php echo (isset($sort_field)?$sort_field:get_cookie('faq_field'));?>" />
							...
							<input type="text" class="search" name="date" id="add_date" value="<?php if(isset($search_date) && ($search_date!="")){echo $search_date;}?>" placeholder="Search by added date" style="width: 130px;background: none;">
							<div class="ui-select" style="width: 125px;">
								<select name="search_option" id="search_option">
									
									
									<option value="" selected="selected">Select an option</option>
									<option value="title" <?php if(isset($search_option) && ($search_option=='title')){echo 'selected="selected"';}?>>Question</option>
									<option value="details" <?php if(isset($search_option) && ($search_option=='details')){echo 'selected="selected"';}?>>Answer</option>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('faq/multiple_option_faq'); ?>">
					...
					<input type="hidden" name="get_search" id="get_search" value="<?php if(isset($_REQUEST['search_text'])){echo $_REQUEST['search_text'];}?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5">
										<a id="title" href="javascript:void(0);" onclick="sortField('title');" style="color:#000;text-decoration: none;">Question
										<?php
											if($sort_field=='title')
											{
												if($sort_type=="DESC")
									...
									<th class="span5">
										<a id="details" href="javascript:void(0);" onclick="sortField('details');" style="color:#000;text-decoration: none;">Answer
										<?php
									...
									<th class="span3">
										<a id="addeddate" href="javascript:void(0);" onclick="sortField('addeddate');" style="color:#000;text-decoration: none;">Added Date
										<?php
											if($sort_field=='addeddate')
											{
												if($sort_type=="DESC")
												{
													echo "<img src='".base_url()."images/sort_desc.png' />";
