...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/location/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Location Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('location/addlocation'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				<div class="row-fluid head"><div class="span12"><!--<h4 class="management_name">Location List</h4>--></div></div>
				<div class="row-fluid filter-block">
					...
					<div class="pull-left">
						<form name="search_form" id="search_form" method="post" action="">
							...
							?>
							<input type="hidden" id="sort_type" name="sort_type" value="<?php echo (isset($sort_type)?$sort_type:get_cookie('sports_ location_type'));?>" />
							<input type="hidden" id="sort_field" name="sort_field" value="<?php echo (isset($sort_field)?$sort_field:get_cookie('sports_location_field'));?>" />
							...
							<input type="text" placeholder= "Location" class="search" name="location" id="location" value="<?php if(isset($location) && ($location!="")){echo $location;}?>">
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('location/multiple_option_location'); ?>">
					...
					<input type="hidden" name="get_search" id="get_search" value="<?php if(isset($_POST['get_search'])){echo $_POST['get_search'];}?>">
					<div class="row-fluid">
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5">
									<a id="location" href="javascript:void(0);" onclick="sortField('location');" style="color:#000;text-decoration: none;">
								...
								<?php
									...
									?>
										...
										<tr class="first">
											...
											<td><?php echo $dataone->location; ?></td>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('location/editlocation');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('location/delete_location');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
