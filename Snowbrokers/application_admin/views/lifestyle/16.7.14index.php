...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/lifestyle/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Lifes tyle Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('lifestyle/addlifestyle'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				...
				<div class="row-fluid filter-block">
					...
					<div class="pull-right">
						<form name="search_form" id="search_form" method="post" action="">
							...
							?>
							<input type="hidden" id="sort_type" name="sort_type" value="<?php echo (isset($sort_type)?$sort_type:get_cookie('sports_lifestyle_type'));?>" />
							<input type="hidden" id="sort_field" name="sort_field" value="<?php echo (isset($sort_field)?$sort_field:get_cookie('sports_lifestyle_field'));?>" />
							...
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="name" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='name')){echo "selected";}?>>Life style Name</option>
								</select>
							</div>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('lifestyle/multiple_option_state'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5"><a id="name" href="javascript:void(0);" onclick="sortField('name');" style="color:#000;text-decoration: none;">life style Name
										<?php
											if($sort_field=='name')
											{
												if($sort_type=="DESC")
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('lifestyle/editlifestyle');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			var r=confirm("Are you sure to delete this lifestyle?");
			
			if (r==true)
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('lifestyle/delete_lifestyle');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
