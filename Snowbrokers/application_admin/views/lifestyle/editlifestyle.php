...
$dataone_fetch = $this->modellifestyle->getDatastate($this->input->post('ListingUserid'));
...
<!--<script type="text/javascript" src="<?php echo base_url(); ?>ckeditor/ckeditor.js"></script>-->
    ...
    <div class="table-products">
	   ...
	   <div class="row-fluid">
		  <div id="main-stats">
			 <div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4>Edit life style ( <span style="color: red;">*</span>  Fields are mandatory)</h4></div></div>
				...
				<div class="row-fluid form-wrapper">
				    ...
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('lifestyle/edit_lifestyle');?>" name="new_category" id="new_category" method="post" autocomplete="off">
							 ...
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span9 required" label="Lifestyle Name" name="name" id="name" style="width: 50%;" value="<?php echo $dataone_fetch[0]->name;?>" >
								
				          <input type="hidden" class="span9" label="Life style Name" name="tablename" id="tablename" style="width: 50%;" value="lifestyle">
					  <input type="hidden" class="span9" label="Life style Name" name="feildname" id="feildname" style="width: 50%;" value="name">
...
//	if (val.search(/\S/)!=-1) {
//			$.ajax({
//			url: "<?php echo base_url(); ?>index.php/lifestyle/check_unic_edit",
//			data: {
//		         val:val,
//			 tablename:tablename,
//			feildname:feildname,
