...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Who We Are Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('who_we_are/add_who_we_are'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('who_we_are/multiple_option_category'); ?>">
								...
								<?php
									...
									?>
										...
										<tr class="first">
											...
											<td>
											<img src="<?php echo GET_LOGO_PATH;?>who_we_are_logo/thumbnail/<?php echo $dataone->logo; ?>" height="80" width="100">
											</td>
...
<script type="text/javascript">
	$(function () {
        $('.Edit_task_cat').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('who_we_are/edit_who_we_are');?>");
	...
	$(function () {
        $('.Delete_task_cat').click(function (e) {
			...
			var r=confirm("Are you sure to delete this Who we are details?");
			
			if (r==true)
			{
			    $('#ListingTaskid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('who_we_are/delete_who_we_are');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
