            ...
            <div id="main-stats">
                <div class="table-products">
                    <div class="row-fluid head">
                        <div class="span12">
                            <h4>Edit Manage user section</h4>
                        </div>
                    </div>
                    ...
                    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
                        <div class="container">
                            <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('manage_user_section/update_task_category');?>" id="frmValidation" method="post">
			    <input type="hidden" name="task_id" id="task_id" value="<?php echo $edit_who_we_are[0]->id;?>"/>
			    <input type="hidden" name="logo_name_hidden" id="logo_name_hidden" value="<?php echo $edit_who_we_are[0]->logo;?>"/>
                            
				<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
                                    <label><span style="color: red;">*</span>Title:</label>
                                    <input type="text" class="span9" name="title" id="title" style="width: 50%;" value="<?php echo set_value('title'); ?><?php echo $edit_who_we_are[0]->title;?>">
				    <div id="title_error" style="color:red;"><?php echo form_error('title'); ?></div>
                                </div>
				<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
                                    <label><span style="color: red;">*</span>Logo:(Present Logo)</label>
                                    <img src="<?php echo GET_LOGO_PATH;?>images/usersection/thumbnail/<?php echo $edit_who_we_are[0]->logo; ?>" height="80" width="100"><br/>
				...
				<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<textarea class="span9" label="Description" name="message" id="message"><?php echo $edit_who_we_are[0]->description; ?></textarea>
					...
					<label>Status:</label>
					 <div class="ui-select">
						    ...
						    <option value="1" <?php if($edit_who_we_are[0]->status=='1') { echo "selected";}?>>Active</option>
						    <option value="0" <?php if($edit_who_we_are[0]->status=='0') { echo "selected";}?>>Inactive</option>
					    </select>
					</div>
				</div>
                                ...
                                <div class="span11 field-box actions" style="margin-top: 20px;">
                                    <input type="button" value="submit" class="btn-glow primary" id="updateTaskCat">
                                    <span>OR</span>
