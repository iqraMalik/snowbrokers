...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/clientsay/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Client Say Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('clientsay/addclientsay'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				...
				<div class="row-fluid filter-block">
					...
					<div class="pull-right">
						<form name="search_form" id="search_form" method="post" action="">
							...
							<input type="hidden" id="sort_type" name="sort_type" value="<?php echo (isset($sort_type)?$sort_type:get_cookie('clientsay_type'));?>" />
							<input type="hidden" id="sort_field" name="sort_field" value="<?php echo (isset($sort_field)?$sort_field:get_cookie('clientsay_field'));?>" />
							...
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="client_name" <?php if(isset($search_option) && ($search_option=='client_name')){echo 'selected';}?>>Client Name</option>
									<option value="client_email" <?php if(isset($search_option) && ($search_option=='client_name')){echo 'selected';}?>>Client Email</option>
								</select>
							</div>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('clientsay/multiple_option_clientsay'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5"><a id="title" href="javascript:void(0);" onclick="sortField('client_name');" style="color:#000;text-decoration: none;">Client Name
										<?php
									...
									<th class="span5"><a id="details" href="javascript:void(0);" onclick="sortField('client_email');" style="color:#000;text-decoration: none;">Client Email
										<?php
											if($sort_field=='client_email')
											{
												if($sort_type=="DESC")
												{
													echo "<img src='".base_url()."images/sort_desc.png' />";
									...
									<th class="span3"><a id="details" href="javascript:void(0);" onclick="sortField('client_say');" style="color:#000;text-decoration: none;">Client Say
										<?php
											if($sort_field=='client_say')
											{
												if($sort_type=="DESC")
												{
													echo "<img src='".base_url()."images/sort_desc.png' />";
							...
							<tbody>
								<?php
									...
									{ 
										...
										$clientsay=substr($dataone->client_say,0,50);
									?>
										<!-- row -->
										<tr class="first">
											...
											<td><?php echo $dataone->client_name; ?></td>
											
											
											<td><?php echo $dataone->client_email; ?></td>
											<td><?php  echo $clientsay;?></td>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('clientsay/editclientsay');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			var r=confirm("Are you sure to delete this client say?");
			
			if (r==true)
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('clientsay/delete_clientsay');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
