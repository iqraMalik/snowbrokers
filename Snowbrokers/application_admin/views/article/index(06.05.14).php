						...
						<form name="search_form" id="search_form" method="post" action="">
							...
							<div class="btn-group pull-left" style="padding-right: 10px;">
								...
								<button class="glow left large" href="javascript:void(0);" value="2" onclick="display_active_inactive(2);"><span style="<?php echo $style2;?>"> In-Active </span></button>
							      ...
							      <div class="ui-select">
								   ...
								   <select name="cat_type" id="cat_type" label="Category Type" onChange="seaarch_cat();">
							...
							<div class="ui-select">
								<select name="search_option" id="search_option">
									<option value="article_title" <?php if(isset($search_option) && ($search_option=='article_title')){echo 'selected';}?>>Article Title</option>
								</select>
							</div>
								...
								<?php
									...
									?>
										...
										<tr class="first">
											...
											<td>
								<?php
								if(!empty($dataone->category))
								{
									$name=$this->modeladmin->getCategoryName($dataone->category);
