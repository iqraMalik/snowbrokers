...
<!-- /TinyMCE -->
    <div class="table-products">
	   ...
	   <div class="row-fluid">
		  <div id="main-stats">
			 <div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4>Add Article ( <span style="color: red;">*</span>  Fields are mandatory)</h4></div></div>
				...
				<div class="row-fluid form-wrapper">
				    ...
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('article/insert_article');?>" name="new_article" id="new_article" method="post" autocomplete="off">
							 ...
							 <div class="span6 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								<label><span style="color: red;">*</span> Article Description :</label>
				   <textarea rows="15" cols="80" style="width: 50%"  label="Article Description" name="a_desc" id="tinyeditor" class="tinymce"></textarea>
