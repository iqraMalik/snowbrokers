...
<script type="text/javascript" src="<?php echo base_url(); ?>../assets/js/jscolor.js"></script>
    ...
    <div class="table-products">
	   ...
	   <div class="row-fluid">
		  <div id="main-stats">
			 <div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4>Add  Color ( <span style="color: red;">*</span>  Fields are mandatory)</h4></div></div>
				...
				<div class="row-fluid form-wrapper">
				    ...
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('product_color/insert_color');?>" name="new_category" id="new_category" method="post" autocomplete="off" onsubmit="return chkfrm()">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							 ...
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="color" id="color" name="color" label="color" autocomplete="off" style="background-image: none;">
							 ...
							 <div class="span11 field-box actions" style="margin-top: 20px;">
								<input type="button" value="Add color" class="btn-glow primary" id="createUser">
								<span>OR</span>
