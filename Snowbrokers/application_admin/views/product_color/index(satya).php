						...
						<form name="search_form" id="search_form" method="post" action="">
							...
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="color_code" selected="selected">Color</option>
									<!--<option value="title" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='color_code')){echo "selected";}?>>Title</option>-->
								</select>
							</div>
							
							<input type="text" class="search" name="get_search" placeholder="Search by color coed" id="get_search" value="<?php if(isset($_REQUEST['get_search']) ){echo $_REQUEST['get_search'];}?>">
