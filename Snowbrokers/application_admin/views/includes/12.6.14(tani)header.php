		...
		<div class="navbar navbar-inverse">
			<div class="navbar-inner">
				...
				<ul class="nav pull-right">                
					...
					{
					    //echo $this->input->post('encrypt_task_id');die;
					   
					    $site_name=$site_name.'index.php/signup/index';
					...
					else
					{
					    ...
					    //redirect('signup/my_account');
					      $site_name=$site_name.'index.php/signup/myaccount';
				...
				<div id="main-stats">
				    <div class="row-fluid stats-row" style="background-color:#DAE1E8">
					   <div class="span3 stat">
						...
						<span class="date" style="color:#000">Instructor</span>
					    </div>
						<div class="span3 stat">
						<div class="data">
						...
						<span class="date" style="color:#000">company</span>
					    </div>
