...
<html class="login-bg">
	<head>
		<title>Snowbrokers Admin - Dashboard</title>
	...
	<body>
		...
		<div class="navbar navbar-inverse">
			<div class="navbar-inner">
				...
				<a class="brand" href="<?php echo site_url('dashboard/index'); ?>">SNOWBROKERS</a>
		...
		<div class="content">
			...
			<div class="container-fluid">
				...
				if($this->uri->segment(1)=='dashboard')
				{
					...
					$instructor =$this->modeladmin->instructornumber();
					$comapany =$this->modeladmin->companynumber();
				?>
				<div id="main-stats">
				    <div class="row-fluid stats-row" style="background-color:#DAE1E8">
					   <div class="span3 stat">
						...
						<span class="date" style="color:#000">Buyer</span>
					    </div>
					    
					    <div class="span3 stat">
						<div class="data">
						    <span class="number"><?php echo $instructor;?></span>
						    Total
						</div>
						<span class="date" style="color:#000">Seller</span>
					    </div>
						<div class="span3 stat">
						<div class="data">
						    <span class="number"><?php echo $comapany;?></span>
						    Total
						</div>
						<span class="date" style="color:#000">Product</span>
					    </div>
