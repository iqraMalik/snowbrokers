...
function go_reset()
{
	location.href="<?php echo base_url();?>index.php/group/index";
}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Album Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('album/addalbum'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				...
				<div class="row-fluid filter-block">
					...
					<div class="pull-left">
						<form name="search_form" id="search_form" method="post" action="">
							...
							?>
							<input type="hidden" id="sort_type" name="sort_type" value="<?php echo (isset($sort_type)?$sort_type:get_cookie('group_type'));?>" />
							<input type="hidden" id="sort_field" name="sort_field" value="<?php echo (isset($sort_field)?$sort_field:get_cookie('group_field'));?>" />
							...
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="group_name" <?php if(isset($search_option) && ($search_option=='group_name')){echo 'selected';}?>>Group Name</option>
								</select>
							</div>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('group/multiple_option_group'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span3">
										<a id="albumn_name" href="javascript:void(0);" onclick="sortField('albumn_name');" style="color:#000;text-decoration: none;">
										Album Name
										<?php
											if($sort_field=='albumn_name')
											{
												if($sort_type=="DESC")
												{
													echo "<img src='".base_url()."images/sort_desc.png' />";
								...
								<?php
									...
									?>
										...
										<tr class="first">
											...
											<?php $geteventcreator = $this->modelalbum->Geteventcreatorsingle($dataone->user_id);
											...
											<td><?php echo $dataone->albumn_name; ?></td>										
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('group/editgroup');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('group/delete_group');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
