			 ...
			 <div class="table-products">
				...
				<div class="row-fluid form-wrapper">
				    ...
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('newsleter_subscription_management/insert_newsleter_subscription_management');?>" name="new_user" id="new_user" method="post" autocomplete="off">
