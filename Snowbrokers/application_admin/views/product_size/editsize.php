...
$dataone_fetch = $this->model_size->getDataCategory($this->input->post('ListingUserid'));
...
<script type="text/javascript" src="jscolor.js"></script>
    ...
    <div class="table-products">
	   ...
	   <div class="row-fluid">
		  <div id="main-stats">
			 <div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4>Edit size ( <span style="color: red;">*</span>  Fields are mandatory)</h4></div></div>
				...
				<div class="row-fluid form-wrapper">
				    ...
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('product_size/edit_category');?>" name="new_category" id="new_category" method="post" autocomplete="off" onsubmit="return chkfrm()">
						 ...
						 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span9 required" id="size" name="size" label="Size" autocomplete="off" value="<?php echo $dataone_fetch[0]->size_type;?>"style="background-image: none; width: initial;">
