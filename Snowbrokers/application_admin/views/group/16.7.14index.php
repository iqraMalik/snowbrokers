...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Group Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('group/addgroup'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span3">
										<a id="group_name" href="javascript:void(0);" onclick="sortField('group_name');" style="color:#000;text-decoration: none;">
										Group Name
										<?php
								...
								<?php
									...
									?>
										...
										<tr class="first">
											...
											<?php $geteventcreator = $this->modelgroup->Geteventcreatorsingle($dataone->user_id);
											...
											<td><?php echo $dataone->group_name; ?></td>										
