...
function go_reset()
{
	location.href="<?php echo base_url();?>index.php/citymanagement/index";
}
...
<div class="table-products">
    <div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
        <div class="span12">
			...
			<div class="pull-right"><a class="btn-flat new-product" href="<?php echo site_url('citymanagement/addcity'); ?>">+ Add New</a></div>
        </div>
    </div>
    <div class="row-fluid">
            <div id="main-stats">
                <div class="table-products">
                    <div class="row-fluid head">
                        <div class="span12">
                            <h4 class="management_name">City List</h4>
                        </div>
                    </div>
							...
							<form name="search_form" id="search_form" method="post" action="">
								<div class="ui-select">
									<select name="search_option" id="search_option">
										<option value="CityName" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='CityName')){echo "selected";}?>>Name</option>
									</select>
								</div>
							...
							<table class="table table-hover">
								...
								if(count($city_list) > 0)
								{
									...
									<tr class="first">
										...
										<td><?php echo $this->modeladmin->GetCountryNameFromCountryID($dataone->Country_ID); ?></td>
										<td><?php echo $this->modeladmin->GetStateNameFromStateID($dataone->State_ID); ?></td>
										...
										<td>
											<ul class="actions">
												...
												<li class="last"><a class="Deleteuser" id="Edituser<?php echo $dataone->city_ID;?>" href="javascript:void(0);"><i class="table-delete"></i></a></li>
											</ul>
										</td>
									</tr>
									<?php
