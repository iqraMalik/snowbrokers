		...
		<div class="span12">
			...
			<div class="pull-right" style="margin-bottom: 5px;">
				<?php
						...
						$newstatusnew=$this->uri->segment(3);
							if($newstatusnew =='new')
							{
							?>
				<span style="padding-left: 10px;">
				<a class="btn-flat new-product" href="<?php echo site_url('taskaroo/index'); ?>">+ Show All</a>
				</span>
				<?php  } ?>
				<a class="btn-flat new-product" href="<?php echo site_url('taskaroo/addtaskaroo'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
					...
					<div class="pull-left">
						<form name="search_form" id="search_form" method="post" action="">
							...
							<div class="btn-group pull-left" style="padding-right: 10px;">
								<button class="glow left large" href="javascript:void(0);" value="1" onclick="display_active_inactive(1);"><span style="<?php echo $style1;?>"> Approve </span></button>
								<button class="glow left large" href="javascript:void(0);" value="2" onclick="display_active_inactive(0);"><span style="<?php echo $style2;?>"> Disapprove </span></button>
							</div>
