...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/taskamount/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Task Amount Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('taskamount/addtaskamount'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
						...
						<form name="search_form" id="search_form" method="post" action="">
							...
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="amount" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='amount')){echo "selected";}?>>Task Amount</option>
								</select>
							</div>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('taskamount/multiple_option_taskamount'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5"><a id="title" href="javascript:void(0);" onclick="sortField('amount');" style="color:#000;text-decoration: none;">Task Amount
										<?php
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('taskamount/edittaskamount');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			var r=confirm("Are you sure to delete this Task Amount?");
			
			if (r==true)
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('taskamount/delete_taskamount');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
