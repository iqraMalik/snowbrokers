				...
				<div class="span9 with-sidebar">
					<div class="container">
						<form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('event/insert_event');?>" name="new_event" id="new_event" method="post" autocomplete="off">
							...
							<div class="span12 field-box" id="recurring_div1" style="display:none;">
								<label><span style="color: red;">*</span> Recurring Upto</label>
								<input type="text" label="Recurring UPTO" name="reccring_upto" value="" id="reccring_upto" placeholder="Recurring Upto..." />
								<div id="reccring_upto_error" class="error_div" style="color:red;"></div>
								
							</div>
								<script type="text/javascript">
								var dateToday = new Date();
								$('#reccring_upto').pickadate({
