					   ...
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('state/edit_state');?>" name="new_category" id="new_category" method="post" autocomplete="off">
							 ...
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span9 required" label="Category Title(in Persian)" name="name_pe" id="name_pe" style="width: 50%;" value="<?php echo $dataone_fetch[0]->state_name_pe;?>">
