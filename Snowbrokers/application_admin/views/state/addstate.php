					   ...
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('state/insert_state');?>" name="new_category" id="new_category" method="post" autocomplete="off">
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								<label><span style="color: red;"></span> Select Country :</label>
							       <?php
							       $TypeData = $this->modelstate->get_state_country();
							       //print_r($TypeData);
							       ?>
							       <div class="ui-select">
								...
								<input type="text" class="span9 required" label="State" name="name" id="name" style="width: 50%;">
