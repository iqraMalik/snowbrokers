...
<!--<script type="text/javascript" src="<?php //echo base_url(); ?>ckeditor/ckeditor.js"></script>-->
    <div class="table-products">
	   ...
	   <div class="row-fluid">
		  <div id="main-stats">
			 <div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4>Add State ( <span style="color: red;">*</span>  Fields are mandatory)</h4></div></div>
				<div class="row-fluid filter-block">
					  <div class="pull-right"><a class="btn-flat new-product" href="<?php echo site_url('subcategory/index'); ?>">< View List</a></div>
				</div>
				<div class="row-fluid form-wrapper">
				    <!-- left column -->
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('state/insert_state');?>" name="new_category" id="new_category" method="post" autocomplete="off">
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								<label>Select Country :</label>
								   ...
								   <select name="country" id="country" label="country" class="span9" style="width: 130%;">
								      ...
								      {
								      ?>
								      <option value="<?php echo $data_type->id;?>"><?php echo $data_type->country_name;?></option>     
								      <?php
								      }
								      ?>
								   </select>  
							 ...
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span9 required" label="State Title(in English)" name="name" id="name" style="width: 50%;">
								<div id="name_error" class="error_div" style="color:red;"></div>
							 </div>
                                                         <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								<label><span style="color: red;">*</span> State Title(in Persian) :</label>
								<input type="text" class="span9 required" label=" State Title(in Persian)" name="name_pe" id="name_pe" style="width: 50%;">
								<div id="name_pe_error" class="error_div" style="color:red;"></div>
							 </div>
                                                         <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								<label><span style="color: red;">*</span> State Title(in Pashto) :</label>
								<input type="text" class="span9 required" label="Category Title(in Pashto)" name="name_pa" id="name_pa" style="width: 50%;">
							 ...
							 <div class="span11 field-box actions" style="margin-top: 20px;">
								<input type="button" value="Add State" class="btn-glow primary" id="createUser">
								<span>OR</span>
