...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/subcategory/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Category Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('subcategory/addsubcategory'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4 class="management_name">Category List</h4></div></div>
						...
						<form name="search_form" id="search_form" method="post" action="">
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="name" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='name')){echo "selected";}?>>Category Name</option>
								</select>
							</div>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('subcategory/multiple_option_subcategory'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5">Subcategory Name</th>
									<th class="span3">Parent Category</th>
									<th class="span3">Subcategory Icon</th>
								...
								<?php
									...
									?>
										...
										<tr class="first">
											...
											<td>
											<?php
											if($dataone->cat_id==null)
											{
												echo "N/A";
											}
											else
											{
												$Parent_Category=$this->modelsubcategory->parentCategory($dataone->cat_id);
											...
											<td><img src="<?php echo $thumbImage.$dataone->image; ?>" /></td>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('subcategory/editsubcategory');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('subcategory/delete_subcategory');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
