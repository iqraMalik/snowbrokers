...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/product_subcat/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Product SubCategory Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('product_subcat/addproductsubcat'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('product_subcat/multiple_option_subcat'); ?>">
						...
						<table class="table table-hover">
							...
							<tbody>
								<?php
											...
											<?php $subcat_id = $dataone->cat_id;
											$scat = $this->model_productsubcat->get_subcat($subcat_id);
											?>
											
											<td><?php echo $scat[0]['name'];?></td>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('product_subcat/editsubcat');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('product_subcat/delete_subcat');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
