...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/media/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name"> Social Media Management</h4>
			<!--<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('category/addcategory'); ?>">+ Add New</a></div>-->
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				...
				<div class="row-fluid filter-block">
					<div class="pull-right">
						<form name="search_form" id="search_form" method="post" action="">
							...
							?>
							<input type="hidden" id="sort_type" name="sort_type" value="<?php echo (isset($sort_type)?$sort_type:get_cookie('classified_media_type'));?>" />
							<input type="hidden" id="sort_field" name="sort_field" value="<?php echo (isset($sort_field)?$sort_field:get_cookie('classified_media_field'));?>" />
							...
							<input type="text" class="search" name="get_search" id="get_search" value="<?php if(isset($search_text) && ($search_text!="")){echo $search_text;}?>" placeholder="Search by Link">
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('media/multiple_option_media'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<!--<th class="span5">
										<a id="label_in" href="javascript:void(0);" onclick="sortField('label_in');" style="color:#000;text-decoration: none;">Label In English
										<?php
											if($sort_field=='label_in')
											{
												if($sort_type=="DESC")
												{
									...
									<th class="span3">Icon</th>
									<th class="span3">
										<a id="status" href="javascript:void(0);" onclick="sortField('status');" style="color:#000;text-decoration: none;">Status
										<?php
							...
							<tbody>
								<?php
									if(count($faq) > 0)
									{
										...
										$thumbImg = main_url()."images/media/thumbs/";
									?>
										<!-- row -->
										<tr class="first">
											...
											<!--<td><?php echo $dataone->label_in; ?></td>-->
									 	 	 	 			
											
											<td><?php echo $dataone->link; ?></td>
											<td><img src="<?php echo $thumbImg.$dataone->icon; ?>" /></td>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('media/editmedia');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			var r=confirm("Are you sure to delete this Media?");
			
			if (r==true)
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('media/delete_media');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
