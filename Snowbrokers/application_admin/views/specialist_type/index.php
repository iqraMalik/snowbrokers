...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/specialist_type/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Specialist Type Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('specialist_type/addspecialist_type'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4 class="management_name">Specialist Type List</h4></div></div>
						...
						<form name="search_form" id="search_form" method="post" action="">
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="name" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='name')){echo "selected";}?>>Type Name</option>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('specialist_type/multiple_option_specialist_type'); ?>">
					...
					<div class="row-fluid">
						<table class="table table-hover">
							...
							<tbody>
								<?php
									if(count($specialist_type) > 0)
									{
										foreach ($specialist_type as $dataone):
									...
									?>
										...
										<tr class="first">
											...
											<td>
											<?php
											if($dataone->main_id==0)
											{
												echo "N/A";
											}
											else
											{
												$SubTypeData = $this->modelspecialist->SpecialistMainType($dataone->main_id);
												//print_r($SubTypeData);
												foreach($SubTypeData as $sub_type)
												{
													echo $sub_type->name;
												}
											}
											...
											<td><?php echo $dataone->description; ?></td>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('specialist_type/editspecialist_type');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			var r=confirm("Are you sure to delete this specialist type?");
			
			if (r==true)
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('specialist_type/delete_specialist_type');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
