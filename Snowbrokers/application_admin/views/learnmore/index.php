...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/learnmore/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Learn More Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('learnmore/addlearnmore'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4 class="management_name">Learn More List</h4></div></div>
						...
						<form name="search_form" id="search_form" method="post" action="">
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="title" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='title')){echo "selected";}?>>Learn More Title</option>
								</select>
							</div>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('learnmore/multiple_option_learnmore'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5">Learn More Title</th>
							...
							<tbody>
								<?php
									if(count($learnmore_list) > 0)
									{
										foreach ($learnmore_list as $dataone):
									?>
										<!-- row -->
										<tr class="first">
											...
											<td><?php echo $dataone->add_date; ?></td>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('learnmore/editlearnmore');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('learnmore/delete_learnmore');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
