			...
			<div class="table-products">
				...
				<div class="span9 with-sidebar">
				   ...
				   <textarea  style="width: 50%"  label="Description" name="a_desc" id="a_desc" ></textarea>
							...
							<div class="span12 field-box">
		    <!----------------------------------------------- Start of Upload Video section ----------------------------------------------->
							<div  style="margin-left: 30px;">
							<label>Upload Video :</label>
							    <div style="padding-bottom:15px;">
								<input type="radio" name="video_upload_type" id="form_video_url_yt" value='0' onclick="go_video_type(0);" >&nbsp;&nbsp;Youtube Link &nbsp;&nbsp;&nbsp;
								<input type="radio" name="video_upload_type" id="form_video_url_vm" value='1' onclick="go_video_type(1);" >&nbsp;&nbsp;Vimeo Link &nbsp;&nbsp;&nbsp;
								<input type="radio" name="video_upload_type" id="form_image_url" value='2' onclick="go_video_type(2);">&nbsp;&nbsp;Upload Video
							    </div>
							   
							    <div id="video_url">
								
									
								<input type="text" name="image_url" id="my_video_url" value="">&nbsp;&nbsp;&nbsp;
								    <input type="button" name="reset" onclick="pageLoad();" value="reset" />	
								    <div id="my_video_url_error" class="error_div" style="color:red;"></div>
									<!--<input type="hidden" name="site_settings[video_upload_type]" id="video_type" value="<?php //echo $settings['video_upload_type']; ?>">-->
							    </div>
							    <div id="video"><input type="file" name="video" id="image" ></div>
							</div>
