...
function go_reset()
{
	location.href="<?php echo base_url();?>index.php/user/index";
}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">User Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('user/adduser'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
						...
						<form name="search_form" id="search_form" method="post" action="">
							...
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="customer_type_b" <?php if(isset($search_option) && ($search_option=='customer_type_b')){echo 'selected';}?>>Buyer</option>
									<option value="customer_type_s" <?php if(isset($search_option) && ($search_option=='customer_type_s')){echo 'selected';}?>>Seller</option>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('user/multiple_option_user'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span3">
										<a id="last_name" href="javascript:void(0);" onclick="sortField('customer_type');" style="color:#000;text-decoration: none;">
										User type
										<?php
								...
								<?php
									...
									?>
										...
										<tr class="first">
											...
											<td><?php if( $dataone->customer_type == 0 ){ echo 'N/A';} elseif( $dataone->customer_type == 1 ){ echo "Buyer"; }elseif($dataone->customer_type == 2){ echo "Seller"; } ?></td>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('user/edituser');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('user/delete_user');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
