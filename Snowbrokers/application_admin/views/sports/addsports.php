...
<!--<script type="text/javascript" src="<?php //echo base_url(); ?>ckeditor/ckeditor.js"></script>-->
    <div class="table-products">
	   ...
	   <div class="row-fluid">
		  <div id="main-stats">
			 <div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4>Add Sports ( <span style="color: red;">*</span>  Fields are mandatory)</h4></div></div>
				...
				<div class="row-fluid form-wrapper">
				    ...
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('sports/insert_sports');?>" name="new_category" id="new_category" method="post" autocomplete="off">
							
                                                         <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								<label><span style="color: red;">*</span> Sports Name:</label>
								<input type="text" class="span9 required" label="Sports Name" name="name" id="name" style="width: 50%;" >
					     <input type="hidden" class="span9 required" label="Life style Name" name="tablename" id="tablename" style="width: 50%;" value="sports">
