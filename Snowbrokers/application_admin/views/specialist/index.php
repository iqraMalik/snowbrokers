...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/specialist/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Specialist Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('specialist/addspecialist'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4 class="management_name">Specialist List</h4></div></div>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('specialist/multiple_option_specialist'); ?>">
						...
						<table class="table table-hover">
							...
							<tbody>
								<?php
									...
									{
										foreach ($specialist_list as $dataone):
									?>
										<!-- row -->
										<tr class="first">
											...
											<td>
											<?php
											$TypeData = $this->modeladmin->GetSpecialistMainType($dataone->type);
											if(count($TypeData)>0)
											{
											...
											<td><?php echo $dataone->first_name." ".$dataone->last_name; ?></td>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('specialist/editspecialist');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('specialist/delete_specialist');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
