						  ...
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('specialist/edit_specialist');?>" name="new_specialist" id="new_specialist" method="post" autocomplete="off">
							...
							<div id="edit_div<?php echo $data_done_address->id?>">
							       ...
							       <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								      ...
								      <input type="text" class="span5" label="Business Website Url" name="edit_business_website[]" id="edit_business_website<?php echo $data_done_address->id;?>" value="<?php echo htmlentities($data_done_address->website_url)?>">
								      <div id="edit_business_website_error<?php echo $data_done_address->id;?>" class="error_div" style="color:red;"></div>
							       </div>
							       
							       <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								      <label>Business Email :</label>
								      <input type="text" class="span5" label="Business Email" name="edit_business_email[]" id="edit_business_email<?php echo $data_done_address->id;?>" value="<?php echo htmlentities($data_done_address->email)?>">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>Business Website Url :</label>
							       <input type="text" class="span5" label="Business Website Url" name="business_website[]" id="business_website" onblur="check_business_url(this.value);">
							       <div id="business_website_error" class="error_div" style="color:red;"></div>
							</div>
							
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>Business Email :</label>
							       <input type="text" class="span5" label="Business Email" name="business_email[]" id="business_email" onblur="check_business_email(this.value);">
							       <div id="business_email_error" class="error_div" style="color:red;"></div>
							</div>
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>Country Name:</label>
							       <?php $CountryData = $this->modeladmin->GetAllCountry();?>
							       <select name="country[]" id="country" class="span5" onchange="GetStateFromCountry(this.value);" label="Country">
								       <option value="">Select Country</option>
								       <?php foreach ($CountryData as $dataone): ?>
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
						       ...
						       <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>City Name:</label>
							       <label id="citycontent">
								       <input type="text" class="span5" value="" label="City" name="city[]" id="city">
							       </label>
						       ...
						       <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>Street :</label>
							       <label id="citycontent">
								       <input type="text" class="span5" value="" label="Street" name="street[]" id="street">
							       </label>
						       ...
						       <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>Zipcode :</label>
							       <label id="citycontent">
								       <input type="text" class="span5" value="" label="Zipcode" name="zipcode[]" id="zipcode">
							       </label>
							       <div id="zipcode_error" class="error_div" style="color:red;"></div>
						       </div>
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>Address :</label>
							       <textarea class="span5" label="Address" name="address[]" id="address"></textarea>
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>Business Phone :</label>
							       <label id="citycontent">
								       <input type="text" class="span5" value="" label="Business Phone" name="business_phone[]" id="business_phone">
							       </label>
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>Business Fax :</label>
							       <label id="citycontent">
								       <input type="text" class="span5" value="" label="Business Fax" name="business_fax[]" id="business_fax">
							       </label>
	   ...
	   $(document).ready(function () {
	     ...
	     function check_business_url(val)
	     {
	      if (val!="")
	      {
		     ...
		     if (!re.test(val))
		     {
			    document.getElementById('business_website_error').innerHTML="Please write proper url";
