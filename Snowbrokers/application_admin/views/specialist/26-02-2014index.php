						...
						<form name="search_form" id="search_form" method="post" action="">
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="name" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='article_title')){echo "selected";}?>>Name</option>
								</select>
							</div>
								...
								<?php
									...
									?>
										...
										<tr class="first">
											...
											if($dataone->type==6)
											{
												echo "Obstetrics/Gynecology";
											}
											if($dataone->type==7)
											{
												echo "Orthopedics(bone docs)";
											}
											if($dataone->type==8)
											{
												echo "Emergency Centers";
											}
											?>
											</td>
