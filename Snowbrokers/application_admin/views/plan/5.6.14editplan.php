					  ...
					  <option value="3" <?php if($dataone_fetch[0]->plan_for==3){echo "selected";}else{echo "";}?>>Company</option>
					   ...
					   <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							 ...
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="text" name="price" id="price" label="Price" class="span9 required" value="<?php echo $dataone_fetch[0]->price;?>">
							       <div id="price_error" class="error_div" style="color:red;"></div>
							 </div>
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>Time period (in days):</label>
						 <input type="text" name="time_period" id="time_period" label="Time period" class="span9" value="<?php echo $dataone_fetch[0]->time_period;?>"><br/>
							 ...
							 <!-- <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							  ...
							  <input type="hidden" name="plannamehidden[]" id="fid" value="<?php echo $rows->id; ?>">
