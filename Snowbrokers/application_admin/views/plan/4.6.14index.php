...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/static_page/index";
	}
...
<div class="table-products">
	...
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4 class="management_name">Plan List</h4></div></div>
						...
						<form name="search_form" id="search_form" method="post" action="">
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="planname" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='planname')){echo "selected";}?>>planname</option>
									<option value="details" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='details')){echo "selected";}?>>Details</option>
				...
				?>
					...
					<input type="checkbox" name="scripts[]" class="checkbox_class" id="checkbox_<?php echo $dataone->id;?>" style="margin: 0px;" value="<?php echo $dataone->id;?>" onclick="go_check_all();">
                                       <?php //echo $number;?>
											...
											<td>
												<?php
												$sub_description=substr($dataone->details,0,150);
												...
												echo $sub_description.$dot_description;
												?>
											</td>
