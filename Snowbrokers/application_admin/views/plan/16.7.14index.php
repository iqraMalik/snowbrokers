...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Plan Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('plan/addplan'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('plan/multiple_option_plan'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5"><a id="price" href="javascript:void(0);" onclick="sortField('price');" style="color:#000;text-decoration: none;">Plan Price
										<?php
											if($sort_field=='price')
											{
												if($sort_type=="DESC")
							...
							<th class="span5"><a id="price" href="javascript:void(0);" onclick="sortField('plan_type');" style="color:#000;text-decoration: none;">Plan Type
										<?php
											if($sort_field=='plan_type')
											{
												if($sort_type=="DESC")
												{
													echo "<img src='".base_url()."images/sort_desc.png' />";
								...
								<?php
									...
									?>
										...
										<tr class="first">
											...
											<td><?php echo $dataone->planname; ?></td>
											<td><?php echo $dataone->price; ?></td>
											<td><?php if($dataone->plan_type==1){echo "free";}else{echo "payable";} ?></td>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('plan/editplan');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('plan/delete_plan');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
