				...
				<div class="row-fluid form-wrapper">
				    ...
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   ...
					   <div id="divtoshow" style="display: none;">
					    <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>price :</label>
							       <input type="text" name="price" id="price" label="Price" class="span9">(In $)
							       <div id="price_error" class="error_div" style="color:red;"></div>
							 </div>
					   <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>Time period :</label>
							       <input type="text" name="time_period" id="time_period" label="Time period" class="span9">days(30 days)(year 365 days)
							       <div id="time_period_error" class="error_div" style="color:red;"></div>
							 </div>
							 </div>
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								<label>Features :</label>
								<textarea class="span9" label="features" name="planfeatures" id="planfeatures" class="span9 required"></textarea>
