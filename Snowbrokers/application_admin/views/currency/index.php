						...
						<div class="container">
							...
							<input type="hidden" id="currency_id" value="<?php if($currency_id->id!=''){echo $currency_id->id;}else{echo "";}?>">
								...
								<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								    <label style="font-size: 16px;"><span style="color: red;">*</span>$1=€ <span style="padding-left: 5px;padding-top: 10px;"><input type="text" class="span9 required" label="Euro" id="euro" name="euro" style="width: 50%;" value="<?php if($currency_id->euro!=''){echo $currency_id->euro;}else{echo "";}?>" onkeyup="check_number(this.value,'euro');"></span></label>
								    
								    <div id="euro_error" class="error_div" style="color:red;"></div>
								</div>
								<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								    <label style="font-size: 16px;"><span style="color: red;">*</span>$1=£ <span style="padding-left:5px;padding-top: 10px;"><input type="text" class="span9 required" label="pound" name="pound" id="pound" style="width: 50%;" value="<?php if($currency_id->pound!=''){echo $currency_id->pound;}else{echo "";}?>" onkeyup="check_number(this.value,'pound');"></span>
								    </label>
