				...
				<div class="row-fluid filter-block">
					...
					<div class="pull-right">
						<form name="search_form" id="search_form" method="post" action="">
							...
							?>
							<input type="hidden" id="sort_type" name="sort_type" value="<?php echo (isset($sort_type)?$sort_type:get_cookie('taskaroo_tasksubcategorytype_type'));?>" />
							<input type="hidden" id="sort_field" name="sort_field" value="<?php echo (isset($sort_field)?$sort_field:get_cookie('taskaroo_tasksubcategorytype_field'));?>" />
							...
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="title" <?php if(isset($search_option) && ($search_option=='title')){echo "selected";}?>>Sub-Category Title</option>
								</select>
							</div>
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5">
										<a id="title" href="javascript:void(0);" onclick="sortField('title');" style="color:#000;text-decoration: none;">Task Sub-Category Title
										<?php
											if($sort_field=='title')
											{
												if($sort_type=="DESC")
									...
									<th class="span5">
									<a id="title" href="javascript:void(0);" onclick="sortField('category_id');" style="color:#000;text-decoration: none;">Sub-Category of
										<?php
