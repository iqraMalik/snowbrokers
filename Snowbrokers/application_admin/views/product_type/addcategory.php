...
<script type="text/javascript" src="<?php echo base_url(); ?>ckeditor/ckeditor.js"></script>
    <div class="table-products">
	   <div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;"><div class="span12"><h4>Category Article Management</h4></div></div>
	   <div class="row-fluid">
		  <div id="main-stats">
			 <div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4>Add  Article Category ( <span style="color: red;">*</span>  Fields are mandatory)</h4></div></div>
				...
				<div class="row-fluid form-wrapper">
				    ...
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('category_article/insert_category');?>" name="new_category" id="new_category" method="post" autocomplete="off">
							 ...
							 <div class="span11 field-box actions" style="margin-top: 20px;">
								<input type="button" value="Create Article category" class="btn-glow primary" id="createUser">
								<span>OR</span>
