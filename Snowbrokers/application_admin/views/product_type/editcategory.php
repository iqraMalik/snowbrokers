...
$dataone_fetch = $this->model_category->getDataCategory($this->input->post('ListingUserid'));
...
<script type="text/javascript" src="<?php echo base_url(); ?>ckeditor/ckeditor.js"></script>
    ...
    <div class="table-products">
	   ...
	   <div class="row-fluid">
		  <div id="main-stats">
			 <div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4>Edit Category ( <span style="color: red;">*</span>  Fields are mandatory)</h4></div></div>
				<div class="row-fluid filter-block">
					  <div class="pull-right"><a class="btn-flat new-product" href="<?php echo site_url('category_article/index'); ?>">< View List</a></div>
				</div>
				<div class="row-fluid form-wrapper">
				    <!-- left column -->
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('category_article/edit_category');?>" name="new_category" id="new_category" method="post" autocomplete="off">
							 <input type="hidden" name="id" id="id" value="<?php echo $this->input->post('ListingUserid'); ?>" />
							 
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								<label>Select Category :</label>
							       <?php $TypeData = $this->model_category->CategoryType();?>
							       <div class="ui-select">
								   <select name="category_type" id="category_type" label="Category Type" class="span9" style="width: 130%;">
								      ...
								      {
									     if($data_type->id==$dataone_fetch[0]->main_id)
									     {
								      ...
								      ?>
								      <option value="<?php echo $data_type->id;?>" <?php echo $select_type;?>><?php echo $data_type->name;?></option>     
								      <?php
								      }
								      ?>
								   </select>  
							 ...
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span9" label="Category Alias" name="category_alias" id="category_alias" style="width: 50%;" value="<?php echo $dataone_fetch[0]->alias;?>">
							 ...
							 <div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<textarea class="span9" label="Category Description" name="a_desc" id="a_desc"><?php echo $dataone_fetch[0]->description;?></textarea>
							 ...
							 <div class="span11 field-box actions" style="margin-top: 20px;">
								...
								<span>OR</span>
								<a class="btn-flat new-product" href="<?php echo site_url('category_article/index'); ?>">Cancel</a>
							 </div>
						  </form>
					   </div>
				    </div>
