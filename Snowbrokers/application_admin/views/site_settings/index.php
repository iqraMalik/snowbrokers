...
-->								<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">									
								    <label><span style="color: red;">*</span>Background Image :</label>
								    <input type="file" class="span9" label="Background Image" name="bg_img" id="bg_img" style="width: 50%;" value="">
									<div id="bg_img_error" class="error_div" style="color:red;"></div>
								</div>
								<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								    <label><span style="color: red;">*</span>Middle section background color :</label>
								    <input type="text" class="span9 required color" label="Background color" name="site_settings[bg_color]" id="color" style="width: 50%;" value="<?php if(!empty($settings['bg_color'])){echo $settings['bg_color'];}else{echo "";} ?>">
						...
						<!--		</div>-->
						<!--		<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">-->
						<!--		    <label>Inside Banner Text :</label>-->
						<!--    <textarea class="span9 ckeditor" label="upload lower text" name="site_settings[upload_lower_text]" id="upload_lower_text"><?php //echo $settings['upload_lower_text'];?></textarea><br/>-->
						<!--   -->
						<!--		    <div id="upload_lower_text_error" class="error_div" style="color:red;"></div>-->
						<!--		</div>-->
						<!--		<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">-->
						<!--		    <label>Add Banner text :</label>-->
						<!--    <textarea class="span9 ckeditor" label="Add Banner text" name="site_settings[Add_Banner_text]" id="Add_Banner_text"><?php //echo $settings['Add_Banner_text'];?></textarea><br/>-->
						<!--    -->
						...
						<!--		</div>-->
								...
								<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								    <label><span style="color: red;">*</span>Copy Right text :</label>
					    <input type="text" class="span9 required" label="Copy Right text" name="site_settings[Copy_Right_text]" id="Copy_Right_text" style="width: 50%;" value="<?php if(!empty($settings['Copy_Right_text'])){echo $settings['Copy_Right_text'];}else{echo "";} ?>">
									<div id="Copy_Right_text_error" class="error_div" style="color:red;"></div>
								</div>
								<!--image -->
								<!--<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
...
//.............offline inside banner/add banner............
