			...
			<div class="table-products">
				...
				<div class="row-fluid form-wrapper">
					<div class="span9 with-sidebar" style="margin-bottom: 30px;">
						<div class="container">
							<form class="site_settings_form" action="<?php echo site_url('site_settings/update_settings');?>" name="site_settings" id="site_settings" method="post" autocomplete="off">
								...
								<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
									...
									<div id="linkedin_error" class="error_div" style="color:red;"></div>
								</div>
								<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
