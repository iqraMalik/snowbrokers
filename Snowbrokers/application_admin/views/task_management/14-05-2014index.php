		...
		<div id="main-stats">
			<div class="table-products">
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('task_management/multiple_option_task_management'); ?>">
					...
					<input type="hidden" name="pagination_number" id="pagination_number" value="<?php if($get_search!=''){echo $this->uri->segment(5);}else{echo $this->uri->segment(3);}?>">
					<div class="row-fluid">
						<table class="table table-hover">
							<thead>
								<tr>
									<th class="span1"><input type="checkbox" name="check_all" id="check_all" style="margin: 0px;"></th>
									<th class="span3">Task Title</th>
									<th class="span7">Task Description</th>
...
<script type="text/javascript">
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			var r=confirm("Are you sure to delete this task_management?");
