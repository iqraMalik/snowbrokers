					   ...
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('task_management/insert_task_management');?>" name="new_category" id="new_category" method="post" autocomplete="off">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="text" class="span9 required" label="Address" name="address" id="address" style="width: 50%;">
							       <div id="address_error" class="error_div" style="color:red;"></div>
							</div>
							
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label><span style="color: red;">*</span> City:</label>
							       <input type="text" class="span9 required" label="City" name="city" id="city" style="width: 50%;">
							       <div id="city_error" class="error_div" style="color:red;"></div>
							</div>
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label><span style="color: red;">*</span> State:</label>
							       <input type="text" class="span9 required" label="State" name="state" id="state" style="width: 50%;">
							       <div id="state_error" class="error_div" style="color:red;"></div>
							</div>
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label><span style="color: red;">*</span> Zip:</label>
							       <input type="text" class="span9 required" label="Zip" name="zipcode" id="zipcode" style="width: 50%;">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <textarea class="span9 required" label="Private Note" name="private_note" id="private_note" style="width:50%;resize: none;"></textarea>
							       <div id="private_note_error" class="error_div" style="color:red;"></div>
							</div>
							
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label>&nbsp;</label>
							       <input type="radio" name="task_complete" id="task_complete0" value="0" style="margin-right: 5px;margin-bottom: 4px;">I need a confirmed TaskRabbit by<br/>
							       <input type="radio" name="task_complete" id="task_complete1" value="1" style="margin-right: 5px;margin-bottom: 4px;">I need this Task completed by
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="radio" name="task_assignment" id="task_assignment0" value="0" style="margin-right: 5px;margin-bottom: 4px;">Pick for me (most popular)
							       <input type="radio" name="task_assignment" id="task_assignment1" value="1" style="margin-left: 20px;margin-right: 5px;margin-bottom: 4px;">Based on availability and price
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="checkbox" name="additional_details[]" id="additional_details1" value="1" style="margin-right: 5px;margin-bottom: 4px;">Let me review offers before auto assignment<br/>
							       <input type="checkbox" name="additional_details[]" id="additional_details2" value="2" style="margin-right: 5px;margin-bottom: 4px;">Give first dibs to one of our top 5 TaskRabbits<br/>
							       <input type="checkbox" name="additional_details[]" id="additional_details3" value="3" style="margin-right: 5px;margin-bottom: 4px;">This task can be done online or by phone<br/>
							       <input type="checkbox" name="additional_details[]" id="additional_details4" value="4" style="margin-right: 5px;margin-bottom: 4px;">This task required a large vehicle (truck, SUV etc.)<br/>
							       <input type="checkbox" name="additional_details[]" id="additional_details5" value="5" style="margin-right: 5px;margin-bottom: 4px;">This task is private<br/>
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="checkbox" name="task_repeat" id="task_repeat" value="1" style="margin-left: 20px;margin-right: 5px;margin-bottom: 4px;">Repeat this task
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="radio" name="task_spend" id="task_spend0" value="0" style="margin-right: 5px;margin-bottom: 4px;">Less than $25
							       <input type="radio" name="task_spend" id="task_spend1" value="1" style="margin-left: 20px;margin-right: 5px;margin-bottom: 4px;">Less than $50
							       <input type="radio" name="task_spend" id="task_spend2" value="2" style="margin-left: 20px;margin-right: 5px;margin-bottom: 4px;">Less than $100
							       <input type="radio" name="task_spend" id="task_spend3" value="3" style="margin-left: 20px;margin-right: 5px;margin-bottom: 4px;">More than $100
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="text" class="span9 required" label="Amount" name="task_amount" id="task_amount" style="width: 50%;" onkeyup="check_number(this.value);">
