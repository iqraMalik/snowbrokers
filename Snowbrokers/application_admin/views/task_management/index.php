...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/task_management/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Task/Project Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('task_management/addtask_management'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				<div class="row-fluid head"><div class="span12"></div></div>
				<div class="row-fluid filter-block">
					<div class="pull-left">&nbsp;&nbsp;&nbsp;
						...
						<a href="javascript:void(0);" onclick="go_multiple_option(3);"><img src="<?php echo main_url();?>images/deactive.png" alt="Inactive" title="Inactive"></a>
					</div>
					<div class="pull-right">
						<form name="search_form" id="search_form" method="post" action="">
							...
							?>
							<input type="hidden" id="sort_type" name="sort_type" value="<?php echo (isset($sort_type)?$sort_type:get_cookie('taskaroo_post_task_type'));?>" />
							<input type="hidden" id="sort_field" name="sort_field" value="<?php echo (isset($sort_field)?$sort_field:get_cookie('taskaroo_post_task_field'));?>" />
							...
							<div class="btn-group pull-left" style="padding-right: 10px;">
								...
								<button class="glow left large" href="javascript:void(0);" value="0" onclick="display_active_inactive(0);" style="border-radius: 5px 5px 5px 5px;border-right: 1px solid #CCCCCC;"><span style="<?php echo $style2;?>"> In-Active </span></button>
							</div>
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="task_title" <?php if(isset($search_option) && ($search_option=='task_title')){echo "selected";}?>>Task Title</option>
                                                                        <option value="task_description" <?php if(isset($search_option) && ($search_option=='task_description')){echo "selected";}?>>Task Description</option>
								</select>
							</div>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('task_management/multiple_option_task_management'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span3">
										<a id="people.first_name" href="javascript:void(0);" onclick="sortField('people.first_name');" style="color:#000;text-decoration: none;">
										Name
										<?php
											if($sort_field=='people.first_name')
											{
												if($sort_type=="DESC")
												{
									...
									<th class="span3">
										<a id="post_task.task_title" href="javascript:void(0);" onclick="sortField('post_task.task_title');" style="color:#000;text-decoration: none;">
										Task Title
										<?php
											if($sort_field=='post_task.task_title')
											{
												if($sort_type=="DESC")
												{
													echo "<img src='".base_url()."images/sort_desc.png' />";
									...
									<th class="span7">
										<a id="post_task.task_description" href="javascript:void(0);" onclick="sortField('post_task.task_description');" style="color:#000;text-decoration: none;">
										Task Description
										<?php
											if($sort_field=='post_task.task_description')
											{
												if($sort_type=="DESC")
												{
													echo "<img src='".base_url()."images/sort_desc.png' />";
									...
									<th class="span3">
										<a id="post_task.status" href="javascript:void(0);" onclick="sortField('post_task.status');" style="color:#000;text-decoration: none;">
										Status
										<?php
											if($sort_field=='post_task.status')
											{
												if($sort_type=="DESC")
												{
													echo "<img src='".base_url()."images/sort_desc.png' />";
								...
								<?php
									...
									?>
										...
										<tr class="first">
											...
											<td>
												<?php
												echo $dataone->first_name." ".$dataone->last_name;
												?>
											</td>
											<td><?php echo $dataone->task_title; ?></td>
											<td>
											<?php
											if(strlen($dataone->task_description) < 150)
											{
												echo ($dataone->task_description);
											}
											else
											{
											echo substr($dataone->task_description,0,150).'...';
											}
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('task_management/edittask_management');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('task_management/delete_task_management');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
