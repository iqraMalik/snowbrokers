...
<div class="table-products">
	...
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4 class="management_name">Slider List</h4></div></div>
								...
								<tr class="first">
									...
									<input type="checkbox" name="scripts[]" class="checkbox_class" id="checkbox_<?php echo $dataone->id;?>" style="margin: 0px;" value="<?php echo $dataone->id;?>" onclick="go_check_all();">
											<td><?php echo $dataone->title; ?></td>
                                                                                        <td><img src="<?php echo $this->config->item('slider_img_url').$dataone->image;?>" /></td>
