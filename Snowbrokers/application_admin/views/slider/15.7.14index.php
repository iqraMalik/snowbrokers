						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span3"><a id="title" href="javascript:void(0);" onclick="sortField('title');" style="color:#000;text-decoration: none;">Title
										<?php
											if($sort_field=='title')
											{
												if($sort_type=="DESC")
									...
									<th class="span3"><a id="message" href="javascript:void(0);" onclick="sortField('message');" style="color:#000;text-decoration: none;">Description
										<?php
											if($sort_field=='message')
											{
												if($sort_type=="DESC")
												{
													echo "<img src='".base_url()."images/sort_desc.png' />";
							...
							<tbody>
								...
								<tr class="first">
									...
									<input type="checkbox" name="scripts[]" class="checkbox_class" id="checkbox_<?php echo $dataone->id;?>" style="margin: 0px;" value="<?php echo $dataone->id;?>" onclick="go_check_all();">
											...
											<td><?php echo substr($dataone->message,0,50); ?></td>
