            ...
            <div id="main-stats">
                <div class="table-products">
                    <div class="row-fluid head">
                        <div class="span12">
                            <h4>Add Task Category ( <span style="color: red;">*</span>  Fields are mandatory)</h4>
                        </div>
                    </div>
                    ...
                    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
                        <div class="container">
                            <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('task_category/insert_task_category');?>" id="frmValidation" method="post">
				...
				<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
                                    <label><span style="color: red;">*</span>Category Logo:</label>
