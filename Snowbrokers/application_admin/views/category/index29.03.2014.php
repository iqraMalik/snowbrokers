	...
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('category/multiple_option_category'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5">Category Name</th>
								...
								<?php
									...
									?>
										...
										<tr class="first">
											...
											{
												$Parent_Category=$this->modelcategory->parentCategory($dataone->main_id);
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('category/editcategory');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('category/delete_category');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
