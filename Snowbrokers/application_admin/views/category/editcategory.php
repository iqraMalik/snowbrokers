...
$dataone_fetch = $this->modelcategory->getDataCategory($this->input->post('ListingUserid'));
			 ...
			 <div class="table-products">
				...
				<div class="row-fluid form-wrapper">
				    ...
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('category/edit_category');?>" name="new_category" id="new_category" method="post" autocomplete="off">
