					   ...
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('appointment/edit_appointment');?>" name="new_specialist" id="new_specialist" method="post" autocomplete="off">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="radio" name="appointment_for" id="appointment_for2" value="2" onclick="show_user(this.value);" <?php if($dataone_fetch_appointment[0]->appointment_for==2){echo "checked";}?>>Someone else&nbsp;&nbsp;
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="text" class="span5 required" label="First Name" name="first_name" id="first_name" value="<?php if(!empty($dataone_fetch[0]->name)){echo $dataone_fetch[0]->name;}else{echo $dataone_fetch_appointment[0]->first_name;}?>">
							       <div id="first_name_error" class="error_div" style="color:red;"></div>
							</div>
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label><span style="color: red;">*</span> Last Name :</label>
							       <input type="text" class="span5 required" label="Last Name" name="last_name" id="last_name" value="<?php echo $dataone_fetch_appointment[0]->last_name;?>">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span5 required" label="Appointment Reason" name="appointment_reason" id="appointment_reason" value="<?php if(!empty($dataone_fetch[0]->name)){echo $dataone_fetch_appointment[0]->appointment_reason;}else{echo $dataone_fetch_appointment[0]->appointment_reason;}?>">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span5 required" label="Appointment Date" name="appointment_date" id="appointment_date" value="<?php echo $dataone_fetch_appointment[0]->appointment_date;?>">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span5 required" label="Insurance Name" name="insurance_name" id="insurance_name" value="<?php if(!empty($dataone_fetch[0]->name)){echo $dataone_fetch_appointment[0]->insurance_name;}else{echo $dataone_fetch_appointment[0]->insurance_name;}?>">
