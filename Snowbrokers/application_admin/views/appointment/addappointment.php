...
<script src="<?php echo base_url();?>js/res_datepicker/main.js"></script>
    ...
    <div class="table-products">
	   ...
	   <div class="row-fluid">
		  <div id="main-stats">
			 <div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4>Add Appointment ( <span style="color: red;">*</span>  Fields are mandatory)</h4></div></div>
				...
				<div class="row-fluid form-wrapper">
				    ...
				    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
					   <div class="container">
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('appointment/insert_appointment');?>" name="new_specialist" id="new_specialist" method="post" autocomplete="off">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="radio" name="appointment_for" id="appointment_for1" value="1" onclick="show_user(this.value);" <?php if(isset($_REQUEST['user_details_value'])){ echo "checked";}?>>Existing User&nbsp;&nbsp;
							       <input type="radio" name="appointment_for" id="appointment_for2" value="2" onclick="show_user(this.value);">Someone else&nbsp;&nbsp;
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="text" class="span5 required" label="First Name" name="first_name" id="first_name" value="<?php if(!empty($dataone_fetch[0]->first_name)){echo $dataone_fetch[0]->first_name;}?>">
							       <div id="first_name_error" class="error_div" style="color:red;"></div>
							</div>
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label><span style="color: red;">*</span> Last Name :</label>
							       <input type="text" class="span5 required" label="Last Name" name="last_name" id="last_name" value="<?php if(!empty($dataone_fetch[0]->last_name)){echo $dataone_fetch[0]->last_name;}?>">
							       <div id="last_name_error" class="error_div" style="color:red;"></div>
							</div>
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       <label><span style="color: red;">*</span> Gender :</label>
							       <input type="radio" name="gender" id="gender1" value="1" <?php if(!empty($dataone_fetch[0]->gender)){if($dataone_fetch[0]->gender==1){echo "checked";}}?>>Male&nbsp;&nbsp;
							       <input type="radio" name="gender" id="gender2" value="2" <?php if(!empty($dataone_fetch[0]->gender)){if($dataone_fetch[0]->gender==2){echo "checked";}}?>>Female&nbsp;&nbsp;
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span5 required" label="Appointment Reason" name="appointment_reason" id="appointment_reason">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span5 required" label="Appointment Date" name="appointment_date" id="appointment_date">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span5 required" label="Insurance Name" name="insurance_name" id="insurance_name">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span5 required" label="Confirm Phone Number" name="confirm_phone_number" id="confirm_phone_number" value="<?php if(!empty($dataone_fetch[0]->phone_number)){echo $dataone_fetch[0]->phone_number;}?>">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
								...
								<input type="text" class="span5 required" label="Email Id" name="email" id="email" value="<?php if(!empty($dataone_fetch[0]->email)){echo $dataone_fetch[0]->email;}?>">
							 ...
							 <div class="span11 field-box actions" style="margin-top: 20px;">
								<input type="button" value="Create Appointment" class="btn-glow primary" id="createUser">
								<span>OR</span>
    ...
    <script type="text/javascript">
       $(document).ready(function () {
	      ...
	      function user_details(val)
	      {
		     ...
		     document.getElementById("new_specialist").action = "<?php echo base_url();?>index.php/appointment/addappointment";
