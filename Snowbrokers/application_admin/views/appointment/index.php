...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/appointment/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Appointment Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('appointment/addappointment'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4 class="management_name">Appointment List</h4></div></div>
						...
						<form name="search_form" id="search_form" method="post" action="">
							<div class="ui-select">
								<select name="search_option" id="search_option">
									...
									<option value="name" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='name')){echo "selected";}?>>Name</option>
									<option value="phone_number" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='phone_number')){echo "selected";}?>>Phone Number</option>
									<option value="email" <?php if(isset($_REQUEST['search_option']) && ($_REQUEST['search_option']=='email')){echo "selected";}?>>Email</option>
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('appointment/multiple_option_appointment'); ?>">
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5">Appointment For</th>
									<th class="span5">Name</th>
									<th class="span3">Email</th>
									<th class="span3">Phone Number</th>
							...
							<tbody>
								<?php
									...
									{
										foreach ($appointment as $dataone):
									...
									?>
										...
										<tr class="first">
											...
											<td>
											<?php
											if($dataone->appointment_for==1)
											{
												echo "Existing User";
											}
											if($dataone->appointment_for==2)
											{
												echo "Someone else";
											}
											?>
											...
											<td><?php echo $dataone->confirm_phone_number 	; ?></td>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('appointment/editappointment');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('appointment/delete_appointment');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
