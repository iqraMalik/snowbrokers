...
<script src="<?php echo base_url();?>js/res_datepicker/main.js"></script>
    ...
    <div class="table-products">
	   ...
	   <div class="row-fluid">
		  <div id="main-stats">
			 <div class="table-products">
				<div class="row-fluid head"><div class="span12"><h4>Add Appointment</h4></div></div>
						  ...
						  <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('appointment/insert_appointment');?>" name="new_specialist" id="new_specialist" method="post" autocomplete="off">
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;<?php echo $display_style;?>" id="show_user">
							       ...
							       <div class="ui-select">
								     ...
								     ?>
								     <option value="<?php echo $datauser->id?>"<?php echo $select_user;?>><?php echo $datauser->name?></option>
								     <?php
								     }
								     ?>
								     </select>
							...
							<div class="span12 field-box" style="margin-left: 30px;margin-bottom: 10px;">
							       ...
							       <input type="text" class="span5 required" label="First Name" name="first_name" id="first_name" value="<?php if(!empty($dataone_fetch[0]->name)){echo $dataone_fetch[0]->name;}?>">
