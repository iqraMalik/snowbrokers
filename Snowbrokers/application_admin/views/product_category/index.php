...
<script type="text/javascript">
	...
	function go_reset()
	{
		location.href="<?php echo base_url();?>index.php/product_category/index";
	}
...
<div class="table-products">
	<div class="row-fluid head" style="border-bottom: 1px solid #C5C5C5; margin-bottom: 30px;">
		<div class="span12">
			<h4 class="management_name">Product Category Management</h4>
			<div class="pull-right" style="margin-bottom: 5px;"><a class="btn-flat new-product" href="<?php echo site_url('product_category/addproductcategory'); ?>">+ Add New</a></div>
		</div>
	</div>
	<div class="row-fluid">
		<div id="main-stats">
			<div class="table-products">
				...
				<form name="multiple_form" id="multiple_form" method="post" action="<?php echo site_url('product_category/multiple_option_category'); ?>">
						...
						<table class="table table-hover">
							...
							<tbody>
								<?php
											...
											<?php //$cat_id = $dataone->cat_id;
											//$cat = $this->model_productcategory->get_cat($cat_id);
											?>
...
<script type="text/javascript">
	$(function () {
        $('.Edituser').click(function (e) {
			...
			$("#frmValidation").attr("action", "<?php echo site_url('product_category/editcategory');?>");
	...
	$(function () {
        $('.Deleteuser').click(function (e) {
			...
			{
			    $('#ListingUserid').val($.trim(stripdata));
			    $("#frmValidation").attr("action", "<?php echo site_url('product_category/delete_category');?>");
			    $("#frmValidation").submit();
			    return true;
			}
		});
