						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span5">
									<a id="currrency_symbol" href="javascript:void(0);" onclick="sortField('currrency_symbol');" style="color:#000;text-decoration: none;">

									Currency symbol
									<?php
												if($sort_field=='currrency_symbol')
												{
													if($sort_type=="DESC")
													{
														echo "<img src='".base_url()."images/sort_desc.png' />";
									...
									?>
										...
										<tr class="first">
											...
											<td><?php
											 ...
											 $currency=$dataone->currrency_symbol;
											 if($currency)
											 {
											echo $currency;
											 }
