...
<div class="table-products">
    ...
    <div class="row-fluid">
            <div id="main-stats">
		     ...
		     <?php 
                            	$ImgURL	= 'http://esolz.co.in/lab3/alDente/';
                            	$row = $this->modelchangepassword->getAllchangepassword();
								if(count($row) > 0) {
                    ...
                    <div class="span9 with-sidebar" style="margin-bottom: 30px;">
                        <div class="container">
                            <form class="new_user_form" enctype="multipart/form-data" action="<?php echo site_url('changepassword/changepassword');?>" id="frmValidation" method="post">
